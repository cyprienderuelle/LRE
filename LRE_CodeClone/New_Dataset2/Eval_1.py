...
lora_list = ["./checkpoint_epoch_v2_1", "./checkpoint_epoch_v2_2", "./checkpoint_epoch_v2_3", "./checkpoint_epoch_81acc_1", "./checkpoint_epoch_map70"] # Ton dossier contenant adapter_model.bin
